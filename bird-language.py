...
def translate(phrase):
    return re.sub(f'([{CONSONANTS}])[{VOWELS}]|(?P<vowels>[{VOWELS}])(?P=vowels){{2}}',
                  lambda matchobj: matchobj.group(1) if matchobj.group(1) else matchobj.group(2),
                  phrase)
